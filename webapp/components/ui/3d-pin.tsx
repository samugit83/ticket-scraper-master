...
import { StandRightArrow } from '@/csr_comps/icons'
    ...
    <motion.div className="w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center" >
          ...
          >
            <span className="relative flex items-center z-20 text-white text-xs font-bold inline-block py-0.5 gap-[5px]">
              {title} <StandRightArrow size={20} fill="#3CBAF7" />
            </span>
